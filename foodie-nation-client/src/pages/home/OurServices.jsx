...
const serviceLists = [
    {id:1, title: "Catering", des: "Delight your guests with our flavors", img: "/images/home/services/icon1.png"},
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-12">
        <div className="md:w-1/2">
          <div className="text-left md:w-4/5">
            <h2 className="title text-black">Our Culinary Journey And Services</h2>
            ...
            <div className="grid sm:grid-cols-2 grid-cols-1 gap-8 items-center">
                {
                    serviceLists.map((service) => (
                        <div key={service.id} className="shadow-md mt-2 rounded-sm py-5 px-4 text-center space-y-2 text-green cursor-pointer hover:border hover:border-green-600 transition-all duration-200">
