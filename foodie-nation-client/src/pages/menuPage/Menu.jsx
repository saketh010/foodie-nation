...
const Menu = () => {
  ...
  const menuSectionRef = useRef(null); // Reference to the menu section
  ...
  return (
    <div>
      ...
      {/* Menu shop */}
      <div ref={menuSectionRef} className="section-container">
        <div className="flex flex-col py-7 md:flex-row flex-wrap md:justify-between items-center space-y-3 mb-8">
          {/* All category buttons */}
          <div className="flex flex-row justify-start md:items-center md:gap-8 gap-4 flex-wrap">
            ...
            <button onClick={() => filterItems("MainCourse")} className={selectedCategory === "MainCourse" ? "active" : ""}>
              Main Course
            </button>
